  ...
  es: {
    ...
    menu: {
      ...
      items: {
        ...
        food5:       { title: "Platillo de la Casa", desc: "Receta exclusiva de El Compadre. Sazón de familia en cada mordida." },
  ...
  en: {
    ...
    menu: {
      ...
      items: {
        ...
        food5:       { title: "House Special", desc: "El Compadre's exclusive recipe. Family seasoning in every bite." },
